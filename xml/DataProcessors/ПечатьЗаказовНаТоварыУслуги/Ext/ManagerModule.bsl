...
Процедура Расш6270_ЗаполнитьТабличныйДокументЗаказаНаТоварыУслугиАдаптированДляПеревода(ТабличныйДокумент, ПараметрыЗаполненияПФ, ОбъектыПечати, ПервыйДокумент, КодЯзыка)
	...
	Если ЗначениеЗаполнено(ДанныеПечати.АдресДоставки) Тогда
		...
		#Вставка
		Имя = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоРеквизиту("Имя", "ИмяКлиента_876834a602e143b28fa4fcf8b2e57e3b");
		Имя = УправлениеСвойствами.ЗначениеСвойства(ДанныеПечати.Ссылка, Имя);
		
		Номер = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоРеквизиту("Имя", "Телефон_a075aff4e1eb4736bb68d2d8a0fdb92e");
		Номер = УправлениеСвойствами.ЗначениеСвойства(ДанныеПечати.Ссылка, Номер);
		...
		АдресДоставки.Добавить("Клиент: " + Имя + ", тел. " + Номер);
